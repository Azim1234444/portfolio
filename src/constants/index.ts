export const PERSONAL = {
  name: "Muhammad Nur Azim Abdul Halim",
  firstName: "Azim",
  roles: [
    "Software Engineer",
    "Game Developer",
...
export const SOCIAL_LINKS = {
  ...
  /**
   * WhatsApp number in international format, e.g. "60123456789" for Malaysia
   * (country code 60 + number without the leading 0). Spaces, dashes and a
   * leading "+" are fine — they're stripped before building the wa.me link.
   * Leave empty to hide the WhatsApp chat button entirely.
   */
  whatsapp: "60163495594",
};
